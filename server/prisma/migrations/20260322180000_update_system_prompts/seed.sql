...
-- This migration seeds the system_prompts table with the 6 main agents
...
-- Cartographer Agent (Map/Relationships)
INSERT INTO "system_prompts" ("id", "agentId", "name", "promptText", "model", "temperature", "active", "createdAt", "updatedAt")
VALUES (

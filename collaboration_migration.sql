...
-- Add column to topics table for family sharing
ALTER TABLE topics ADD COLUMN IF NOT EXISTS shared_with_family BOOLEAN DEFAULT FALSE;

-- Add column to skills table for family sharing  
ALTER TABLE skills ADD COLUMN IF NOT EXISTS shared_with_family BOOLEAN DEFAULT FALSE;

-- Success message
SELECT 'Collaboration schema migration completed successfully!' as result;